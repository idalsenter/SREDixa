...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["enableDryRun"] = pulumi.output((_c = (args ? args.enableDryRun : undefined)) !== null && _c !== void 0 ? _c : utilities.getEnvBoolean("PULUMI_K8S_ENABLE_DRY_RUN")).apply(JSON.stringify);
            resourceInputs["enableReplaceCRD"] = pulumi.output((_d = (args ? args.enableReplaceCRD : undefined)) !== null && _d !== void 0 ? _d : utilities.getEnvBoolean("PULUMI_K8S_ENABLE_REPLACE_CRD")).apply(JSON.stringify);
            resourceInputs["enableServerSideApply"] = pulumi.output((_e = (args ? args.enableServerSideApply : undefined)) !== null && _e !== void 0 ? _e : utilities.getEnvBoolean("PULUMI_K8S_ENABLE_SERVER_SIDE_APPLY")).apply(JSON.stringify);
            ...
            resourceInputs["kubeconfig"] = (_f = (args ? args.kubeconfig : undefined)) !== null && _f !== void 0 ? _f : utilities.getEnv("KUBECONFIG");
